...
public class UpdateLevelEditorUI_v7
{
    public static string Execute()
    {
        Cleanup();
        BuildUI();
        return "Level Editor UI Updated Successfully (v7)";
    }
    ...
    private static void BuildUI()
    {
        ...
        // Left 60, Right 220 (to avoid buttons)
        SetAnchor(title.GetComponent<RectTransform>(), AnchorType.Stretch, 60, 0, 220, 0);
        ...
        SetAnchor(actionsContainer.GetComponent<RectTransform>(), AnchorType.Right, -10, 0, 200, 60);
        ...
        timelineVlg.spacing = 5;
        timelineVlg.childControlHeight = false;
    ...
    private static void CreateActionButton(string name, Transform parent, string text, Color color)
    {
        ...
        le.preferredWidth = 50; // Smaller width
