...
public class UpdateLevelEditorUI_v3
{
    public static string Execute()
    {
        Cleanup();
        BuildUI();
        return "Level Editor UI Updated Successfully (v3)";
    }
    ...
    private static void BuildUI()
    {
        ...
        SetAnchor(title.GetComponent<RectTransform>(), AnchorType.Left, 60, 0, 300, 40);
        ...
        SetAnchor(actionsContainer.GetComponent<RectTransform>(), AnchorType.Right, -10, 0, 300, 60);
        ...
        if (tilePalette != null)
        {
            ...
            SetAnchor(tilePalette.GetComponent<RectTransform>(), AnchorType.LeftStretch, 0, 60, 100, 0); // Top 60, Bottom 0, Width 100
        ...
        // Bottom Stretch, but start after sidebar (Left 100)
        SetAnchor(bottomPanel.GetComponent<RectTransform>(), AnchorType.BottomStretch, 100, 0, 0, 200); // Height 200
        ...
        SetAnchor(timelineHeader.GetComponent<RectTransform>(), AnchorType.TopStretch, 10, 5, 0, 25);
        ...
        if (unitTimeline != null)
        {
            ...
            SetAnchor(unitTimeline.GetComponent<RectTransform>(), AnchorType.Stretch, 10, 30, 10, 10);
        ...
        SetAnchor(abHeader.GetComponent<RectTransform>(), AnchorType.TopStretch, 0, 5, 0, 25);
        ...
        SetAnchor(genBtn.GetComponent<RectTransform>(), AnchorType.TopCenter, 0, -35, 180, 40);
        ...
        SetAnchor(sliderContainer.GetComponent<RectTransform>(), AnchorType.TopCenter, 0, -85, 200, 40);
        ...
        SetAnchor(slider.GetComponent<RectTransform>(), AnchorType.BottomCenter, 0, 0, 200, 15);

        // Status Panel
        GameObject statusPanel = CreatePanel("StatusPanel", autoBalanceArea.transform);
        SetAnchor(statusPanel.GetComponent<RectTransform>(), AnchorType.BottomStretch, 10, 10, 10, 60); // Height 60
        ...
        if (levelCanvas != null)
        {
            // Stretch to fill remaining space: Left 100, Top 60, Bottom 200, Right 0
            SetAnchor(levelCanvas.GetComponent<RectTransform>(), AnchorType.Stretch, 100, 60, 0, 200);
