...
public class UpdateLevelEditorUI_v12
{
    ...
    private static void Cleanup()
    {
        ...
        if (unitTimeline != null)
        {
            ...
            ContentSizeFitter csf = unitTimeline.GetComponent<ContentSizeFitter>();
            if (csf != null) Object.DestroyImmediate(csf);
            
            // Remove LayoutElement if present
            LayoutElement le = unitTimeline.GetComponent<LayoutElement>();
    ...
    private static void BuildUI()
    {
        ...
        SetAnchor(timelineArea.GetComponent<RectTransform>(), AnchorType.LeftHalf, 5, 5, 2.5f, 5); 
        SetColor(timelineArea, new Color(0.25f, 0.25f, 0.25f)); // Match AutoBalance background
        ...
        SetAnchor(autoBalanceArea.GetComponent<RectTransform>(), AnchorType.RightHalf, 2.5f, 5, 5, 5);
        ...
        timelineHeader.GetComponent<TextMeshProUGUI>().alignment = TextAlignmentOptions.Center; // Centered
        ...
        if (unitTimeline != null)
        {
            ...
            unitTimeline.transform.SetSiblingIndex(1);
            ...
            timelineHlg.childAlignment = TextAnchor.MiddleCenter;
