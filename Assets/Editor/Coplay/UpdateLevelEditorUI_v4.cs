...
public class UpdateLevelEditorUI_v4
{
    public static string Execute()
    {
        Cleanup();
        BuildUI();
        return "Level Editor UI Updated Successfully (v4)";
    }
    ...
    private static void BuildUI()
    {
        ...
        SetAnchor(timelineHeader.GetComponent<RectTransform>(), AnchorType.TopStretch, 10, 5, 0, 30);
        ...
        if (unitTimeline != null)
        {
            ...
            // Reset anchors to fill remaining space, with more top margin
            SetAnchor(unitTimeline.GetComponent<RectTransform>(), AnchorType.Stretch, 10, 40, 10, 10);
